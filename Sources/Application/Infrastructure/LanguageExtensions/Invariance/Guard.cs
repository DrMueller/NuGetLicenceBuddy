...
using Mmu.NuGetLicenceBuddy.Infrastructure.LanguageExtensions.Invariance.Servants;

namespace Mmu.NuGetLicenceBuddy.Infrastructure.LanguageExtensions.Invariance
{
    [PublicAPI]
